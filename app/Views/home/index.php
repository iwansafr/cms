...
<head>
  ...
  <!-- Favicons -->
  <link href="templates/eterna/assets/img/favicon.png" rel="icon">
  <link href="templates/eterna/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        ...
        <!-- <a href="index.html"><img src="templates/eterna/assets/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background: url(templates/eterna/assets/img/slide/slide-1.jpg)">
          ...
          <!-- Slide 2 -->
          <div class="carousel-item" style="background: url(templates/eterna/assets/img/slide/slide-2.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background: url(templates/eterna/assets/img/slide/slide-3.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="templates/eterna/assets/img/about.jpg" class="img-fluid" alt="">
          </div>
    ...
    <section id="clients" class="clients">
      <div class="container">
        ...
        <div class="owl-carousel clients-carousel">
          <img src="templates/eterna/assets/img/clients/client-1.png" alt="">
          <img src="templates/eterna/assets/img/clients/client-2.png" alt="">
          <img src="templates/eterna/assets/img/clients/client-3.png" alt="">
          <img src="templates/eterna/assets/img/clients/client-4.png" alt="">
          <img src="templates/eterna/assets/img/clients/client-5.png" alt="">
          <img src="templates/eterna/assets/img/clients/client-6.png" alt="">
          <img src="templates/eterna/assets/img/clients/client-7.png" alt="">
          <img src="templates/eterna/assets/img/clients/client-8.png" alt="">
        </div>
